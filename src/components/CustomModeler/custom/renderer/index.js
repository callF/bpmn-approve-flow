...
import { customElements, customConfig, divLabelElements } from '@/components/CustomModeler/helper/config';
...
export default class CustomRenderer extends BaseRenderer {
  ...
  drawShape(parentNode, element) {
    ...
    if (customElements.includes(type)) { // or customConfig[type]
      ...
      if (divLabelElements.includes(type) && element.businessObject.name) {
